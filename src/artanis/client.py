...
class LifespanContextManager:
    def __init__(self, app: "ArtanisService", timeout: float = 60.0):
        self.app = app
...
class _AppClient(_BaseClient):
    def __init__(self, /, app: "ArtanisService", **kwargs):
...
class Client(httpx.AsyncClient):
    ...
    >>> client = Client(app=ArtanisService())
