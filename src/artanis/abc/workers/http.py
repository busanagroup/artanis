...
class HTTPWorker(BaseWorker):
    ...
    def __init__(self, url: str | t.Callable[[], str], app: "ArtanisService | None" = None, **client_kwargs: t.Any):
    ...
    def client(self, client: "Client") -> None:
        ...
        :param client: ArtanisService client.
        """
        self._client = client
