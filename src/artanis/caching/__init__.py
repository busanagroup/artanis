...
from typing import Protocol, TypeVar, Callable, Any, Optional, MutableMapping

from artanis.caching.base import hashkey
from artanis.caching.cache import TTLCache
