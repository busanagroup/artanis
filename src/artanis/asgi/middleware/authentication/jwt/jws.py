...
from artanis.asgi.middleware.authentication.jwt.algorithms import HMACAlgorithm

if t.TYPE_CHECKING:
    from artanis.asgi.middleware.authentication.jwt.algorithms import SignAlgorithm
