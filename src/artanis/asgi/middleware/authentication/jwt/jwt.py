...
from artanis.asgi.middleware.authentication import exceptions
from artanis.asgi.middleware.authentication.jwt import claims
from artanis.asgi.middleware.authentication.jwt.jws import JWS
...
class JWT:
    ...
    @classmethod
    def decode(cls, token: bytes, key: bytes) -> t.Self:
        """Decode a JWT token.
