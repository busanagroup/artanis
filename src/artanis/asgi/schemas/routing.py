...
class ParametersDescriptor:
    def __init__(self, route: "BaseRoute") -> None:
        self._route = route
        self._parent_app: ArtanisService | None = None

    @property
    def _app(self) -> "ArtanisService":
    ...
    @_app.setter
    def _app(self, app: "ArtanisService"):
    ...
    def _build(self, app: "ArtanisService") -> "ParametersDescriptor":
        self._app = app
        return self
