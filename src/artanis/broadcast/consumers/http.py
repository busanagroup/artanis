...
from artanis.broadcast.defs import HttpResponseStartEvent, HttpResponseBodyEvent, HttpRequestEvent, HttpDisconnectEvent
...
class AsyncHttpConsumer(AsyncConsumer):
    ...
    async def http_disconnect(self, message: HttpDisconnectEvent) -> None:  # noqa: D102
        """
