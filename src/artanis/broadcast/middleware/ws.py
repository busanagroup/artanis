...
from typing import TypeAlias, Iterable, Any, cast
from urllib.parse import ParseResult, urlparse

from artanis.broadcast.consumers import AsyncWebsocketConsumer
from artanis.broadcast.defs import ChannelApplication, ChannelScope, ASGIReceiveCallable, ASGISendCallable
from artanis.broadcast.utils import is_same_domain
...
class OriginValidator:
    ...
    def get_origin_port(self, origin: ParseResult) -> int | None:  # noqa: D102
        """
