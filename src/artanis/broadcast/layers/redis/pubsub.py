...
from artanis.broadcast.defs import ChannelMessage
from artanis.broadcast.layers.base import BaseChannelLayer
from artanis.broadcast.layers.redis.defs import SymmetricEncryptionKeys, ChannelRawRedisHost, ChannelDecodedRedisHost
from artanis.broadcast.layers.redis.serializers import registry
from artanis.broadcast.layers.redis.utils import wrap_close, create_pool, close_redis, consistent_hash, decode_hosts
...
class RedisPubSubLoopLayer:
    ...
    async def new_channel(self, prefix: str = "specific.") -> str:
        ...
        """
        channel = f"{self.prefix}{prefix}{uuid.uuid7().hex}"
