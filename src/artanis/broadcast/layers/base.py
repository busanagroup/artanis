...
from artanis.broadcast.defs import ChannelCapacityDict, CompiledChannelCapacities, ChannelMessage


class BaseChannelLayer:
    """
    Base class for channel layers. Subclasses must implement the methods
    defined here.
    """
    ...
    channel_name_regex = re.compile(r"^[A-Za-z0-9.-]+(?:![A-Za-z0-9.-])?$")
