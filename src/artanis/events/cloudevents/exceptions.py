...
class UnsupportedSpecVersionError(ValueError):
    """
    Raised when an unsupported CloudEvents specification version is encountered.
    """

    def __init__(self, spec_version: str) -> None:
        self.spec_version: str = spec_version
        super().__init__(f"Unsupported CloudEvents specification version: '{spec_version}'")
